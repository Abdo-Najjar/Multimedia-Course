    ...
    new Vue({
        ...
        data() {
            return {
               ...
               questionAudioPath: "audio/3.mp3"  ,

               showAnswersAudioPath :"audio/false.mp3" ,
    ...
    methods: {
      ...
      submitAnswer : function(){
        ...
        if(!this.isAnswerTrue()){
          ...
          window.sessionStorage.setItem( "3" , 0);
          

        new Audio(this.showAnswersAudioPath).play();
      ...
      countWrongAnswers: function () {
        ...
        options.forEach(option => {
          ...
          var check = src.includes(`second-${checker}`);
